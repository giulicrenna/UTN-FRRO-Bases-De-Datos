...
('Juan', 'Pérez', '12345678A', 'juan.perez@email.com', '2023-01-15'),
('María', 'Gómez', '87654321B', 'maria.gomez@email.com', '2023-02-20'),
('Carlos', 'López', '11223344C', 'carlos.lopez@email.com', '2023-03-10'),
('Ana', 'Martínez', '55667788D', 'ana.martinez@email.com', '2023-04-05'),
('Luis', 'Rodríguez', '99887766E', 'luis.rodriguez@email.com', '2023-05-12');

INSERT INTO productos (nombre, categoria, precio, stock) VALUES
('Laptop HP', 'Tecnología', 899.99, 15),
('Smartphone Samsung', 'Tecnología', 699.99, 25),
('Mesa de oficina', 'Muebles', 199.50, 10),
('Silla ergonómica', 'Muebles', 149.99, 20),
('Monitor 24"', 'Tecnología', 179.99, 12);


INSERT INTO empleados (id_empleado, nombre, apellido, puesto, salario) VALUES
(101, 'Pedro', 'Sánchez', 'Vendedor', 1850.00),
(102, 'Laura', 'Fernández', 'Gerente', 3200.00),
(103, 'Miguel', 'Díaz', 'Vendedor', 1750.00),
(104, 'Sofía', 'Ramírez', 'Cajero', 1600.00),
(105, 'Jorge', 'Hernández', 'Almacén', 1550.00);


INSERT INTO ventas (id_venta, fecha_venta, id_cliente, id_empleado) VALUES
(1001, '2023-06-01', 1, 101),
(1002, '2023-06-02', 2, 103),
(1003, '2023-06-03', 3, 101),
(1004, '2023-06-03', 4, 104),
(1005, '2023-06-04', 1, 101);
...
SELECT clientes.nombre, clientes.apellido, ventas.fecha_venta, empleados.nombre, empleados.apellido
FROM 
	ventas
...
SELECT productos.nombre,  detalle_venta.cantidad, detalle_venta.precio_unitario, ventas.fecha_venta AS fecha_venta
FROM
detalle_venta
...
-- Ejercicio 8
SELECT productos.stock, productos.nombre, detalle_venta.cantidad 
FROM productos
...
SELECT
	cantidad, 
	precio_unitario, 
	cantidad * precio_unitario AS precioTotal
FROM 
	detalle_venta
...
-- EJERCICIO 10
SELECT clientes.nombre , COUNT(ventas.id_venta) AS cantidad
FROM 
	clientes
